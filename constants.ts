...
export const INITIAL_FILE_SYSTEM: FileNode = dir('/', [
  ...
  dir('home', [
    ...
    file('证据_1.txt', `标题：“未来之星”科技有限公司新产品遭内部举报 日期：2026年1月19日 恰逢公司成立二十周年之际，“未来之星”科技有限公司推出最新产品“智研AI”,，该产品能够理解用户意图和习惯，帮助科研人员完成一系列实验，实现真正的“解放双手”。然而，在当天下午，本台就接到了举报电话，该举报人自称是“未来之星”公司内部人员，宣称公司推出的新产品注入了一个隐藏病毒，如果科研人员使用该产品，就会被窃取所有实验数据。“智研AI”是否真的具有窃取信息的功能，“未来之星”公司是否为窃取行业机密不择手段？本台记者将持续为您报道。（我的记忆没错，公司果然不简单，但他们背叛我的，好像并不是这件事）`, false, true),
    ...
    dir('admin', [
      ...
      dir('data', [
        dir('employees_list', [
          file('职员文件夹说明.txt', `公司职员较多，需要知道对应职员姓名才能查看相关信息`),
...
……\n
【系统批注 - 仅管理员可见】实际来源为本公司“运营部”考核未通过人员。通过药物诱导使其进入假死状态，模拟绝症患者体征，以获取林墨组长的技术支持。\n(原来我一直引以为傲的科研成果，尽是建立在同事的性命之上……)`, false, true)
        ], 'linmo'),
        dir('news', [
...
[[HIDDEN:救...他们盯上我了...用search找王玲日记.txt...]]\n`),
             file('王玲日记.txt', `内容：我知道了公司的阴谋，但是没时间了……，我偷听到他们会把我关在dark2里面，那是哪里？如果有人能发现这篇日记，来救救我……`, true),
...
2. 经查证，实际仅327万元用于患者救治（占比2.57%），其余资金流向如下：
